      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {analyticsData.bookingsGrowth} from last month
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{analyticsData.summary.averageRating}</div>
            <p className="text-xs text-muted-foreground">
              {analyticsData.ratingGrowth} from last month
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{analyticsData.summary.completionRate}%</div>
            <p className="text-xs text-muted-foreground">
              {analyticsData.completionGrowth} from last month
            </p>
          </CardContent>
        </Card>
      </div>
